...
# vcbar.gz --
#
#	Gist drawing style for 2 coordinate systems on a portrait page:
#	  - system 1 is a square to display images, 
#	  - system 2 is a thin rectangle intended to display a vertical
#	    colorbar.
#	Legends: none.
...
system= {
  legend= "Main Window (1)",
  viewport= { 0.19, 0.54, 0.46, 0.81 },
...
system= {
  legend= "Color Bar (2)",
  viewport= { 0.59, 0.61, 0.46, 0.81 },
  ticks= { horiz= { flags= 0x000 }, vert= { flags= 0x04b, nMinor= 0 } }
}
