...
# vcbar4.gs --
#
#	Gist drawing style for 5 coordinate systems on a portrait page:
#	  - system 1-4 are squares to display images, 
#	  - system 5 is a thin rectangle intended to display a vertical
#	    colorbar.
#	Legends: none.
...
default = {
  ...
  ticks= {
    horiz= {
      nMajor= 5,  nMinor= 50.0,  logAdjMajor= 1.2,  logAdjMinor= 1.2,
      nDigits= 3,  gridLevel= 1,  flags= 0x02B,
      tickOff= 0.0065,  labelOff= 0.0104,
#      tickLen= { 0.0052, 0.0026, 0.0026, 0.0000, 0.0000 },
       tickLen= { 0.018, 0.016, 0.008, 0.0054, 0.0036 },
   tickStyle= { color= -2,  type= 1,  width= 1.0 },
      gridStyle= { color= -2,  type= 3,  width= 1.0 },
      textStyle= { color= -2,  font= 0x08,  prec= 2,  height= 0.0130,
    ...
    vert= {
      ...
      tickOff= 0.0065,  labelOff= 0.0117,
 #     tickLen= { 0.0052, 0.0026, 0.0026, 0.0000, 0.0000 },
       tickLen= { 0.018, 0.016, 0.008, 0.0054, 0.0036 },
      tickStyle= { color= -2,  type= 1,  width= 1.0 },
      gridStyle= { color= -2,  type= 3,  width= 1.0 },
...
# a 0.35x0.35 NDC^2 window (~ 9.5x9.5 cm^2)
system= {
  legend= "Data Window (1)",
  viewport= { 0.173, 0.353, 0.642, 0.822 },
  ticks= { horiz= { flags= 0x04b }, vert= { flags= 0x02b } }
}
system= {
  legend= "Data Window (2)",
  viewport= { 0.366, 0.546, 0.642, 0.822 },
  ticks= { horiz= { flags= 0x04b }, vert= { flags= 0x04b } }
}
system= {
  legend= "Data Window (3)",
  viewport= { 0.173, 0.353, 0.449, 0.629 },
  ticks= { horiz= { flags= 0x02b }, vert= { flags= 0x02b } }
}
system= {
  legend= "Data Window (4)",
  viewport= { 0.366, 0.546, 0.449, 0.629 },
  ticks= { horiz= { flags= 0x02b }, vert= { flags= 0x04b } }
}

# The second coordinate system has right ticks and labels
system= {
  legend= "Color Bar (5)",
  viewport= { 0.609, 0.629, 0.449, 0.822 },
  ticks= {
    horiz= { flags= 0x000 },
    vert= { flags= 0x04b, nMajor=12.5, nMinor= 0 }
  }
}
