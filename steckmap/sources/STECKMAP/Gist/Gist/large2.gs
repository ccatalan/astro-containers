...
# A double coordinate system on a portrait page with frame
...
default = {
  ...
  viewport= {  0.1, 0.95, 0.45, 0.7 },

  ticks= {

    horiz= {
      nMajor= 5.0,  nMinor= 25.0,  logAdjMajor= 1.2,  logAdjMinor= 1.2,
      nDigits= 5,  gridLevel= 1,  flags= 0x02b,
...
#      textStyle= { color= -2,  font= 0x08,  height= 0.0182,
      textStyle= { color= -2,  font= 0x09,  height= 0.0182,
...
# textStyle= { color= -2,  font= 0x08,  height= 0.0182,
    ...
    frame= 1,
    frameStyle= { color= -2,  type= 1,  width= 2.0 }}}

system= { legend= "System 0" }

system= { legend= "System 1" ,
  viewport= {  0.1, 0.95, 0.15, 0.4 }}
