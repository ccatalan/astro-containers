...
default = {
  ...
  ticks= {
    ...
    horiz= {
      ...
      tickStyle= { color= -2,  type= 1,  width= 1.5 },
      gridStyle= { color= -2,  type= 3,  width= 1.5 },
    ...
    frame= 1,
    frameStyle= { color= -2,  type= 1,  width= 1.5 }}}

system= { legend= "System 0" }

system= { legend= "System 0",
  viewport= { 0.1, 1.5, 0.4, 0.6 },
  ticks= {
